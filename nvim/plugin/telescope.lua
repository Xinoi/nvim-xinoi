...
vim.keymap.set('n', '<leader><Space>', builtin.live_grep, { desc = '[telescope] live grep' })
vim.keymap.set('n', '<leader>fg', fuzzy_grep, { desc = '[f]uzzy [g]rep' })
vim.keymap.set('n', '<leader>fF', live_grep_current_file_type, { desc = 'live grep filetype' })
vim.keymap.set(
  'n',
  '<leader>f*',
...
vim.keymap.set('n', '<leader>fd', builtin.lsp_document_symbols, { desc = 'telescope lsp [d]ocument symbols' })
